...
fun KoinoorUIScaffold(
    ...
    drawerBackgroundColor: Color = KoinoorTheme.colors.uiBackground,
    drawerContentColor: Color = KoinoorTheme.colors.textSecondary,
    drawerScrimColor: Color = KoinoorTheme.colors.uiBorder,
